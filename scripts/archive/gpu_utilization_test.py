...
def test_memory_allocation():
    ...
    print(
        f"After model: {after_model_memory / 1e6:.1f} MB (+{(after_model_memory-initial_memory)/1e6:.1f} MB)"
    )
    ...
    print(
        f"After batch: {after_batch_memory / 1e6:.1f} MB (+{(after_batch_memory-after_model_memory)/1e6:.1f} MB)"
    )
    ...
    print(
        f"After forward: {after_forward_memory / 1e6:.1f} MB (+{(after_forward_memory-after_batch_memory)/1e6:.1f} MB)"
    )
    ...
    print(
        f"After backward: {after_backward_memory / 1e6:.1f} MB (+{(after_backward_memory-after_forward_memory)/1e6:.1f} MB)"
    )
