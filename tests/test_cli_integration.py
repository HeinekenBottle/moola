...
class TestCLIIntegration:
    ...
    def sample_config_files(self):
        ...
        for name, config in [("relativity", relativity_config), ("zigzag", zigzag_config)]:
    ...
    def test_relativity_cli_integration(self, sample_ohlcv_file, sample_config_files):
        ...
        with tempfile.NamedTemporaryFile(suffix=".parquet", delete=False) as output_file:
            ...
            result = subprocess.run(
                cmd, capture_output=True, text=True, cwd="/Users/jack/projects/moola"
            )
    ...
    def test_cli_output_format(self, sample_ohlcv_file, sample_config_files):
        ...
        with tempfile.NamedTemporaryFile(suffix=".parquet", delete=False) as output_file:
            ...
            print("✅ CLI output format validation passed")
    ...
    def test_model_overfit_test(self):
        ...
        try:
            ...
            # Create model
            model = JadeCompact(input_size=11, hidden_size=96, num_layers=1, num_classes=3, seed=42)
            ...
            assert (
                40000 <= params["total"] <= 80000
            ), f"Jade-Compact should have 40-80K params, got {params['total']:,}"
