...
class Storage11DArchitecture:
    ...
    def migrate_existing_data(self, input_path: Path, output_path: Optional[Path] = None) -> Path:
    ...
    def create_annotation_batch_11d(
        self, window_ids: list, output_path: Optional[Path] = None
    ) -> Path:
        ...
        for key, config in schema.items():
            ...
            if file_path.exists():
                try:
                    ...
                    report["schema_validation"][key] = {"error": str(e), "valid": False}
    ...
    def get_storage_stats(self) -> dict[str, Any]:
        ...
        Returns:
            Storage statistics
        """
        stats = {"total_size_mb": 0, "file_counts": {}, "sample_counts": {}}
