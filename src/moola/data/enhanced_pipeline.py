...
class EnhancedDataPipeline:
    ...
    def ensure_11d_features(self, 
                           ohlc_data: np.ndarray, 
                           relative_data: Optional[np.ndarray] = None) -> np.ndarray:
    ...
    def create_enhanced_dataset(self,
                              ...
                              window_ids: Optional[list] = None) -> Union[EnhancedUnlabeledDataset, EnhancedLabeledDataset]:
        ...
        if labels is not None:
            ...
            for i in range(N):
                window = EnhancedLabeledWindow(
                    ...
                    relative_features=relative_data[i].tolist() if relative_data is not None else None,
                    label=labels[i],
    ...
    def save_enhanced_dataset(self, 
                             dataset: Union[EnhancedUnlabeledDataset, EnhancedLabeledDataset],
...
def load_enhanced_data(data_path: Path, 
                      ensure_11d: bool = True) -> Tuple[np.ndarray, Optional[np.ndarray]]:
